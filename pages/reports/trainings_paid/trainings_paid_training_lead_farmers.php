            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Trainings Paid</li>
                        <li class="active"><a href="index.php?page=training_lead_farmer">Training Lead Farmers</a></li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Paid Field Officer Trainings</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body" style="overflow-x: auto;">
                                    <table id="example1" class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody>
                                            <?php 
                                            $x = 1;
                                                $lfs_training_query = DB::getInstance()->query("SELECT DISTINCT id_field_officer,id_area_coordinator FROM training_lfs WHERE status = 'training_paid'");
