    ...
    <?php
      ...
      if(Input::exists() && Input::get('update_lfs_training') == 'update_lfs_training')
      {
        ...
        $array_training_lfs_update = array("id_training_lfs" =>$id_training_lfs,"training_date"=>$enrolment_date,"id_area_coordinator"=>$id_area_coordinator,"id_district"=>$id_district,"id_parish"=>$id_parish,"id_subcounty"=>$id_subcounty,"id_module"=>$id_module,"id_field_officer"=>$id_field_officer,"id_training_venue"=>$id_training_venue,"module_repetition"=>$module_repetition,"name"=>$name,"male_lfs"=>$male_lfs,"female_lfs"=>$female_lfs,"male_youth_lfs"=>$male_youth_lfs ,"female_youth_lfs"=>$female_youth_lfs ,"total_lfs"=>$total_lfs,"total_youth_lfs"=>$total_youth_lfs,"lfs"=>$lfs,"ofs"=>$ofs,"others"=>$others,"reviewed_by"=>$reviewed_by);
          DB::getInstance()->update('training_lfs',$id_training_lfs,$array_training_lfs_update,'id_training_lfs');
      }
      elseif(Input::exists() && Input::get('delete_lf_training') == 'delete_lf_training'){
                    $id_training_lfs = Input::get('id_training_lfs');
                    DB::getInstance()->query("DELETE FROM training_lead_farmers WHERE id_training_lfs = $id_training_lfs");
                }
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo strtoupper($training->id_training_lfs); ?>">
  Edit
</button> <button id="restricted_to_adminn" type="button" class="btn btn-danger pull-right" data-toggle="modal" data-target="#delete_training_lfs<?php echo strtoupper($training->id_training_lfs); ?>">
                                                                        Delete
                                                                    </button></td> 
      ...
      <div class="modal-body">
         <form class="form-horizontal" action="" method="post">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control select2" style="width: 100%;" name="id_area_coordinator">
                  <option value="<?php echo strtoupper($training->id_training_lfs); ?>"><?php echo strtoupper(getSpecificDetails('area_coordinator','ac_initials','id_area_coordinator='.$training->id_area_coordinator)); ?></option>
                  <?php
                    $query_ac = DB::getInstance()->query("SELECT * FROM area_coordinator");
                    foreach ($query_ac->results() as $query_ac):
                  ?>
                ...
                <?php endforeach; ?>
                    ...
                    <div class="col-sm-10">
                    <select class="form-control select2" style="width: 100%;" name="id_field_officer">
                  <option value="<?php echo strtoupper($training->id_training_lfs); ?>"><?php echo strtoupper(getSpecificDetails('field_officers','field_officer_code','id_field_officer='.$training->id_field_officer)); ?></option>
                  <?php
                    $fo_query = DB::getInstance()->query("SELECT * FROM field_officers");
                    foreach ($fo_query->results() as $fo_query):
                  ?>
                ...
                <?php endforeach; ?>
                    ...
                    <div class="col-sm-10">
                    <select class="form-control select2" style="width: 100%;" name="id_training_venue">
                  <option value="<?php echo strtoupper($training->id_training_lfs); ?>"><?php echo strtoupper(getSpecificDetails('training_venue','venue_name','id_training_venue='.$training->id_training_venue)); ?></option>
                  <?php
                    $training_venue_query = DB::getInstance()->query("SELECT * FROM training_venue");
                    foreach ($training_venue_query->results() as $training_venue_query):
                  ?>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="" method="post">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="submit" name="delete_training_lfs" class="btn btn-primary" value="delete_training_lfs">Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                <!-- /.modal-content -->
