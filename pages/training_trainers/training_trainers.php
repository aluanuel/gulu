...
-->
                ...
                <?php endforeach; ?>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="female_youth_lfs" placeholder="Enter Number of female youth lead farmers" autocomplete="off" required>
                    </div>
                  </div>
                    <div class="row form-group">
                 ...
                 <div class="row form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="male_fos" placeholder="Enter Number of male field officers" autocomplete="off" required>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="female_fos" placeholder="Enter Number of female field officers" autocomplete="off" required>
                    </div>
                  </div>
                    <div class="row form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="male_youth_fos" placeholder="Enter Number of male  youth field officers" autocomplete="off" required>
                    </div>
                  </div>
                    <div class="row form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="female_youth_fos" placeholder="Enter Number of female youth field officers" autocomplete="off" required>
                    </div>
                  </div>
                    <div class="row form-group">
