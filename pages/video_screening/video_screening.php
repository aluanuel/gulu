...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        id_parish = '$id_parish' && id_module = '$id_module'  && module_repetition = '$module_repetition' && male = '$male' && female = '$female' && youth = '$youth' && total_attendance = '$total_attendance'  && report_number = '$report_number' && payment_status = '$payment_status' && training_by ='$training_by'")) {
                        ...
                        $array_training_lfs = array("screening_date" => $enrolment_date, "id_area_coordinator" => $id_area_coordinator, "id_parish" => $id_parish, "id_subcounty" => $id_subcounty, "id_module" => $id_module, "id_field_officer" => $id_field_officer, "id_lead_farmer" => $id_lead_farmer, "id_training_venue" => $id_training_venue, "module_repetition" => $module_repetition, "fo_name" => $fo_name, "lf_name" => $lf_name, "male" => $male, "female" => $female, "youth" => $youth, "total_attendance" => $total_attendance, "report_number" => $report_number, "payment_status" => $payment_status, "other_person_name" => $other_person_name, "person_to_pay" => $person_to_pay, "training_by" => $training_by, "id_user" => $current_user_id);
                                        ...
                                        <form class="form-horizontal" action="" method="post">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control select2" style="width: 100%;" name="training_by">
                                                        <option>--Select--</option>
                                            ...
                                            <div class="box-body" overflow-x="true" style="overflow-x:scroll;">
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $x = 1;
                                                        if ($training = DB::getInstance()->query("SELECT * FROM video_screening WHERE id_user=$current_user_id")) {
                                                            
                                                        }
                                                        else if( $training = DB::getInstance()->query("SELECT * FROM video_screening")){
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form class="form-horizontal" action="" method="post">
                                                                            <input type="hidden" class="form-control" id="inputName" name="id_video_screening" autocomplete="off" required value="<?php echo strtoupper($training->id_video_screening); ?>">
