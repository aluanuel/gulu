...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        id_parish = '$id_parish' && id_module = '$id_module'  && module_repetition = '$module_repetition' && male = '$male' && female = '$female' && youth = '$youth' && total_attendance = '$total_attendance'  && report_number = '$report_number' && payment_status = '$payment_status' && training_by ='$training_by'")) {
                        ...
                        if (DB::getInstance()->insert('video_screening', $array_training_lfs)) {
                ...
                if (Input::exists() && Input::get('update_video') == 'update_video') {
                    $id_video_screening = Input::get('id_video_screening');
                    $enrolment_date = Input::get('screening_date');
                    $fo_name = strtolower(Input::get('fo_name'));
                    $id_field_officer = Input::get('id_field_officer');
                    $lf_name = strtolower(Input::get('lf_name'));
                    ...
                    $array_video_update = array("screening_date" => $enrolment_date, "id_area_coordinator" => $id_area_coordinator, "id_parish" => $id_parish, "id_subcounty" => $id_subcounty, "id_module" => $id_module, "id_field_officer" => $id_field_officer, "id_lead_farmer" => $id_lead_farmer, "id_training_venue" => $id_training_venue, "module_repetition" => $module_repetition, "fo_name" => $fo_name, "lf_name" => $lf_name, "male" => $male, "female" => $female, "youth" => $youth, "total_attendance" => $total_attendance, "report_number" => $report_number, "payment_status" => $payment_status, "other_person_name" => $other_person_name, "person_to_pay" => $person_to_pay, "training_by" => $training_by);
                    if (DB::getInstance()->update('video_screening', $id_video_screening, $array_video_update, 'id_video_screening')) {
                ...
                } elseif (Input::exists() && Input::get('delete_video') == 'delete_video') {
                    $id_video_screening = Input::get('id_video_screening');
                    DB::getInstance()->query("DELETE FROM video_screening WHERE id_video_screening = $id_video_screening");
                }
                ?>
    ...
    ?>
                                                            <tr>
                                                                ...
                                                                <td><!-- Button trigger modal -->
                                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo strtoupper($training->id_video_screening); ?>">
                                                                        Edit
                                                                    </button></td>
                                                                ...
                                                                <!-- Modal -->
                                                        <div class="modal fade" id="exampleModal<?php echo strtoupper($training->id_video_screening); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title text-center" id="exampleModalLabel">Edit Video Screening</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form class="form-horizontal" action="" method="post">
                                                                            <input type="hidden" class="form-control" id="inputName" name="id_video_screening" autocomplete="off" value="<?php echo strtoupper($training->id_video_screening); ?>">
                                                                            ...
                                                                            <div class="row form-group">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="date" class="form-control" id="inputName" name="screening_date" autocomplete="off" value="<?php echo strtoupper($training->screening_date); ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row form-group">
    ...
    foreach ($query_ac->results() as $query_ac):
        ?>
                                                                            ...
                                                                            <div class="row form-group">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="inputName" name="training_by" placeholder="Enter who did the training e.g FO, AC,LF,OTHER" autocomplete="off" value="<?php echo strtoupper($training->training_by); ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row form-group">
    ...
    foreach ($lf_query->results() as $lf_query):
        ?>
                                                                            ...
                                                                            <div class="row form-group">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="inputName" name="other_person_name" placeholder="Enter full name" autocomplete="off" value="<?php echo strtoupper($training->other_person_name); ?>">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row form-group">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="inputName" name="person_to_pay" placeholder="Enter full name" autocomplete="off" value="<?php echo strtoupper($training->person_to_pay); ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row form-group">
    ...
    foreach ($query_pdn_area->results() as $pdn_area):
        ?>
                                                                            ...
                                                                            <div class="row form-group">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="inputName" name="male" placeholder="Enter Number of male" autocomplete="off" value="<?php echo strtoupper($training->male); ?>">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row form-group">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="inputName" name="female" placeholder="Enter Number of females" autocomplete="off" value="<?php echo strtoupper($training->female); ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row form-group">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="inputName" name="youth" placeholder="Enter Number of male youths" autocomplete="off" value="<?php echo strtoupper($training->youth); ?>">
                                                                                </div>
                                                                            </div>
                                                                            <!--<div class="row form-group">
                                                                            ...
                                                                            <div class="row form-group">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="inputName" name="total_attendance" placeholder="Total attendance" autocomplete="off" value="<?php echo strtoupper($training->total_attendance); ?>">
                                                                                </div>
                                                                            </div>
                                                                            <!--<div class="row form-group">
                                                                            ...
                                                                            <div class="row form-group">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="inputName" name="report_number" placeholder="Enter Report Number" autocomplete="off" value="<?php echo strtoupper($training->report_number); ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row form-group">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="inputName" name="payment_status" placeholder="payment status" autocomplete="off" value="<?php echo strtoupper($training->payment_status); ?>">
                                                                                </div>
                                                                            </div>
                                                                            <!--<div class="row form-group">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="submit" name="update_video" class="btn btn-primary" value="update_video">Save changes</button>
                                                                            </div>
